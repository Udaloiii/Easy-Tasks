...
import { TodolistsFromBack } from 'common/api'
...
export type TodolistDomainType = TodolistsFromBack & {
  filter: FilterValuesType
  // entityStatus: RequestStatusType потом создать тип в appReducer ("idle" | "loading" | "succeeded" | "failed")
}
